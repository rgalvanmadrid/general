...
# Multiple example
sources = create_sources.multiple(br=[1.0,0.5,0.3,0.1],Dec_offset=[0.1,-0.2,0.3,-0.4],RA_offset=[0.1,-0.3,0.35,0.5],imsize=imsize,pixscale=pixscale)
...
convl_image = convolve_fft(data,psf_kern)
im_head = psf_header
